...
(
	...
	AUTOMATIC_IN_PROCESS_ID INT NOT NULL CONSTRAINT FK_AUTOMATIC_IN_PROCESS_DETAIL_AUTOMATIC_IN_PROCESS FOREIGN KEY REFERENCES AUTOMATIC_IN_PROCESS (AUTOMATIC_IN_PROCESS_ID),

...
(
	CUSTOMER_ORDER_NOTIFICATION_ID INT NOT NULL IDENTITY(1,1),
	NOTIFICATION_TEMPLATE_ID SMALLINT NOT NULL,
	NOTIFICATION_ID NVARCHAR(450) NOT NULL,
	NOTIFICATION_DATE DATETIME NOT NULL DEFAULT GETDATE(),
	NOTIFIED_MAIL_LIST VARCHAR(MAX) NOT NULL,
	CUSTOMER_ORDER_ID INT NOT NULL,
	NOTIFICATION_STATE SMALLINT NOT NULL,
	NOTIFICATION_SENDING_ERROR_MESSAGE VARCHAR(MAX),	
	CONSTRAINT FK_CUSTOMER_ORDER_NOTIFICATIONS_CUSTOMER_ORDER FOREIGN KEY (CUSTOMER_ORDER_ID) REFERENCES CUSTOMER_ORDERS (CUSTOMER_ORDER_ID),	
	CONSTRAINT FK_CUSTOMER_ORDER_NOTIFICATIONS_NOTIFICATION_TEMPLATE FOREIGN KEY (NOTIFICATION_TEMPLATE_ID) REFERENCES NOTIFICATION_TEMPLATES (NOTIFICATION_TEMPLATE_ID),
	CONSTRAINT PK_CUSTOMER_ORDER_NOTIFICATIONS PRIMARY KEY(CUSTOMER_ORDER_NOTIFICATION_ID)
)
GO

CREATE TABLE customer_reservation_notifications
(
	CUSTOMER_RESERVATION_NOTIFICATION_ID INT NOT NULL IDENTITY(1,1),
	NOTIFICATION_TEMPLATE_ID SMALLINT NOT NULL,
	NOTIFICATION_ID NVARCHAR(450) NOT NULL,
	NOTIFICATION_DATE DATETIME NOT NULL DEFAULT GETDATE(),
	NOTIFIED_MAIL_LIST VARCHAR(MAX) NOT NULL,
	...
	NOTIFICATION_STATE SMALLINT NOT NULL,
	NOTIFICATION_SENDING_ERROR_MESSAGE VARCHAR(MAX),	
	CONSTRAINT FK_CUSTOMER_RESERVATION_NOTIFICATIONS_CUSTOMER_ORDER FOREIGN KEY (CUSTOMER_RESERVATION_ID) REFERENCES CUSTOMER_RESERVATIONS (CUSTOMER_RESERVATION_ID),	
	CONSTRAINT FK_CUSTOMER_RESERVATION_NOTIFICATIONS_NOTIFICATION_TEMPLATE FOREIGN KEY (NOTIFICATION_TEMPLATE_ID) REFERENCES NOTIFICATION_TEMPLATES (NOTIFICATION_TEMPLATE_ID),
	CONSTRAINT PK_CUSTOMER_RESERVATION_NOTIFICATIONS PRIMARY KEY(CUSTOMER_RESERVATION_NOTIFICATION_ID)
)
GO

/****** Object:  Table [log].[track]    Script Date: 5/21/2024 10:19:41 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [log].[track](
	...
	[MODIFIER_NAME] [nvarchar](50) NOT NULL,

...
IF OBJECT_ID('TR_CREATE_LOG_PURCHASE_ORDER', 'TR') IS NOT NULL
	DROP TRIGGER TR_CREATE_LOG_PURCHASE_ORDER

IF OBJECT_ID('TR_MODIFY_LOG_PURCHASE_ORDER', 'TR') IS NOT NULL
	DROP TRIGGER TR_MODIFY_LOG_PURCHASE_ORDER

IF OBJECT_ID('TR_DELETE_LOG_PURCHASE_ORDER', 'TR') IS NOT NULL
	DROP TRIGGER TR_DELETE_LOG_PURCHASE_ORDER
	
IF OBJECT_ID('TR_CREATE_LOG_PURCHASE_ORDER_DETAIL', 'TR') IS NOT NULL
	DROP TRIGGER TR_CREATE_LOG_PURCHASE_ORDER_DETAIL

IF OBJECT_ID('TR_MODIFY_LOG_PURCHASE_ORDER_DETAIL', 'TR') IS NOT NULL
	DROP TRIGGER TR_MODIFY_LOG_PURCHASE_ORDER_DETAIL

IF OBJECT_ID('TR_DELETE_LOG_PURCHASE_ORDER_DETAIL', 'TR') IS NOT NULL
	DROP TRIGGER TR_DELETE_LOG_PURCHASE_ORDER_DETAIL
		
IF OBJECT_ID('TR_CREATE_LOG_CUSTOMER_RESERVATION_LOG', 'TR') IS NOT NULL
	DROP TRIGGER TR_CREATE_LOG_CUSTOMER_RESERVATION_LOG

IF OBJECT_ID('TR_MODIFY_LOG_CUSTOMER_RESERVATION_LOG', 'TR') IS NOT NULL
	DROP TRIGGER TR_MODIFY_LOG_CUSTOMER_RESERVATION_LOG

IF OBJECT_ID('TR_DELETE_LOG_CUSTOMER_RESERVATION_LOG', 'TR') IS NOT NULL
	DROP TRIGGER TR_DELETE_LOG_CUSTOMER_RESERVATION_LOG
...
(
  ...
  CONSTRAINT FK_ALARM_ALARM_TYPE FOREIGN KEY (ALARM_TYPE_ID) REFERENCES ALARM_TYPES (ALARM_TYPE_ID)  
)
GO
...
(
	...
	CONSTRAINT PK_VISUALIZED_ALARM PRIMARY KEY (ALARM_ID, ASPNETUSERS_ID),
	CONSTRAINT FK_VISUALIZED_ALARM_ALARMS FOREIGN KEY (ALARM_ID) REFERENCES ALARMS (ALARM_ID),
	CONSTRAINT FK_VISUALIZED_ALARM_ASPNETUSER FOREIGN KEY (ASPNETUSERS_ID) REFERENCES ASPNETUSERS (ID)
)
GO

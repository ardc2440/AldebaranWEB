...
IF OBJECT_ID('TR_DELETE_LOG_ITEM', 'TR') IS NOT NULL
	DROP TRIGGER TR_DELETE_LOG_ITEM

IF OBJECT_ID('TR_MODIFY_LOG_ITEM', 'TR') IS NOT NULL
	DROP TRIGGER TR_MODIFY_LOG_ITEM

IF OBJECT_ID('TR_CREATE_LOG_ITEM', 'TR') IS NOT NULL
	DROP TRIGGER TR_CREATE_LOG_ITEM

IF OBJECT_ID('TR_CREATE_LOG_ITEM_REFERENCE', 'TR') IS NOT NULL
	DROP TRIGGER TR_CREATE_LOG_ITEM_REFERENCE

IF OBJECT_ID('TR_MODIFY_LOG_ITEM_REFERENCE', 'TR') IS NOT NULL
	DROP TRIGGER TR_MODIFY_LOG_ITEM_REFERENCE

IF OBJECT_ID('TR_DELETE_LOG_ITEM_REFERENCE', 'TR') IS NOT NULL
	DROP TRIGGER TR_DELETE_LOG_ITEM_REFERENCE
...
IF OBJECT_ID('CUSTOMER_ORDER_SHIPMENT_DETAIL_LOG', 'U') IS NOT NULL
	DROP TABLE CUSTOMER_ORDER_SHIPMENT_DETAIL_LOG

IF OBJECT_ID('CUSTOMER_ORDER_SHIPMENT_LOG', 'U') IS NOT NULL
	DROP TABLE CUSTOMER_ORDER_SHIPMENT_LOG
...
IF OBJECT_ID('CUSTOMER_ORDER_IN_PROCESS_DETAIL_LOG', 'U') IS NOT NULL
	DROP TABLE CUSTOMER_ORDER_IN_PROCESS_DETAIL_LOG

IF OBJECT_ID('CUSTOMER_ORDER_IN_PROCESS_LOG', 'U') IS NOT NULL
	DROP TABLE CUSTOMER_ORDER_IN_PROCESS_LOG

IF OBJECT_ID('MODIFIED_ORDER_IN_PROCESS', 'U') IS NOT NULL
	DROP TABLE MODIFIED_ORDER_IN_PROCESS

IF OBJECT_ID('CANCELED_ORDER_IN_PROCESS', 'U') IS NOT NULL
	DROP TABLE CANCELED_ORDER_IN_PROCESS
...
IF OBJECT_ID('CUSTOMER_RESERVATION_DETAIL_LOG', 'U') IS NOT NULL
	DROP TABLE CUSTOMER_RESERVATION_DETAIL_LOG

IF OBJECT_ID('CUSTOMER_RESERVATION_LOG', 'U') IS NOT NULL
	DROP TABLE CUSTOMER_RESERVATION_LOG
...
IF OBJECT_ID('CUSTOMER_ORDER_DETAIL_LOG', 'U') IS NOT NULL
    DROP TABLE CUSTOMER_ORDER_DETAIL_LOG

IF OBJECT_ID('CUSTOMER_ORDER_LOG', 'U') IS NOT NULL
    DROP TABLE CUSTOMER_ORDER_LOG
...
IF OBJECT_ID('ITEM_REFERENCE_LOG', 'U') IS NOT NULL
    DROP TABLE ITEM_REFERENCE_LOG
	
IF OBJECT_ID('ITEM_LOG', 'U') IS NOT NULL
    DROP TABLE ITEM_LOG
...
(
	ITEM_LOG_ID INT NOT NULL IDENTITY(1,1),
	ITEM_ID INT NOT NULL,
	RECORD_LOG_TYPE_ID SMALLINT NOT NULL,
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL ,
	CONSTRAINT PK_ITEM_LOG PRIMARY KEY (ITEM_LOG_ID),
	CONSTRAINT FK_ITEM_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO 
...
CREATE TABLE ITEM_REFERENCE_LOG
(
	ITEM_REFERENCE_LOG_ID INT NOT NULL IDENTITY(1,1),
	REFERENCE_ID INT NOT NULL,
	RECORD_LOG_TYPE_ID SMALLINT NOT NULL,
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL, 
	CONSTRAINT PK_ITEM_REFERENCE_LOG PRIMARY KEY (ITEM_REFERENCE_LOG_ID),
	CONSTRAINT FK_ITEM_REFERENCE_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO 
...
CREATE TABLE [dbo].[AspNetUsers](
	...
	CONSTRAINT UQ_AspNetUsers_IDENTIFICATION_NUMBER UNIQUE (IDENTITY_NUMBER),
    CONSTRAINT UQ_AspNetUsers_FULL_NAME UNIQUE (FULL_NAME),
    CONSTRAINT FK_AspNetUsers_AREA FOREIGN KEY (AREA_ID) REFERENCES AREAS (AREA_ID),
    CONSTRAINT FK_AspNetUsers_IDENTITY_TYPE FOREIGN KEY (IDENTITY_TYPE_ID) REFERENCES IDENTITY_TYPES (IDENTITY_TYPE_ID)
)
GO
...
(
  ...
  CONSTRAINT PK_USER_ALARM_TYPE PRIMARY KEY (ALARM_TYPE_ID,ASPNETUSER_ID),
  CONSTRAINT FK_USER_ALARM_TYPE_ALARM_TYPE FOREIGN KEY (ALARM_TYPE_ID) REFERENCES ALARM_TYPES (ALARM_TYPE_ID),
  CONSTRAINT FK_USER_ALARM_TYPE_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)  
)
GO
...
(
  ...
  CONSTRAINT FK_ADJUSTMENT_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO
...
(
  ...
  CONSTRAINT FK_PURCHASE_ORDER_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (id),
...
(
  ...
  CONSTRAINT FK_CANCELED_PURCHASE_ORDER_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (id)  
)
GO
...
(
  ...
  CONSTRAINT FK_MODIFIED_PURCHASE_ORDER_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (id)  
)
GO
...
(
	...
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 
	DATA_STRING XML NOT NULL, 
	CONSTRAINT PK_PURCHASE_ORDER_LOG PRIMARY KEY (PURCHASE_ORDER_LOG_ID),
	CONSTRAINT FK_PURCHASE_ORDER_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO
...
(
	...
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL ,
	CONSTRAINT PK_PURCHASE_ORDER_DETAIL_LOG PRIMARY KEY (PURCHASE_ORDER_DETAIL_LOG_ID),
	CONSTRAINT FK_PURCHASE_ORDER_DETAIL_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO
...
(
  ...
  CONSTRAINT FK_CUSTOMER_ORDER_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (id),
...
(
  ...
  CONSTRAINT CK_CUSTOMER_ORDER_DETAIL_QUANTITY CHECK ((REQUESTED_QUANTITY >= PROCESSED_QUANTITY) AND (PROCESSED_QUANTITY >= DELIVERED_QUANTITY))  
)
GO
...
(
  ...
  CONSTRAINT FK_CUSTOMER_ORDER_ACTIVITY_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO
...
(
	...
	ACTIVITY_TYPE_ID SMALLINT NOT NULL,
	CONSTRAINT PK_CUSTOMER_ORDER_ACTIVITY_DETAIL PRIMARY KEY (CUSTOMER_ORDER_ACTIVITY_ID, ACTIVITY_TYPE_ID),
...
(
  ...
  CONSTRAINT FK_CANCELED_CUSTOMER_ORDER_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO
...
(
  ...
  CONSTRAINT FK_MODIFIED_CUSTOMER_ORDER_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO
...
(
  ...
  CONSTRAINT FK_CLOSED_CUSTOMER_ORDER_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO

CREATE TABLE CUSTOMER_ORDER_LOG
(
	CUSTOMER_ORDER_LOG_ID INT NOT NULL IDENTITY(1,1),
	CUSTOMER_ORDER_ID int not null,
	RECORD_LOG_TYPE_ID SMALLINT NOT NULL,
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL,
	CONSTRAINT PK_CUSTOMER_ORDER_LOG PRIMARY KEY (CUSTOMER_ORDER_LOG_ID),
	CONSTRAINT FK_CUSTOMER_ORDER_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO

CREATE TABLE CUSTOMER_ORDER_DETAIL_LOG
(
	CUSTOMER_ORDER_DETAIL_LOG_ID INT NOT NULL IDENTITY(1,1),
	CUSTOMER_ORDER_DETAIL_ID INT NOT NULL,
	RECORD_LOG_TYPE_ID SMALLINT NOT NULL,
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL,
	CONSTRAINT PK_CUSTOMER_ORDER_DETAIL_LOG PRIMARY KEY (CUSTOMER_ORDER_DETAIL_LOG_ID),
	CONSTRAINT FK_CUSTOMER_ORDER_DETAIL_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO
...
(
  ...
  CONSTRAINT FK_CUSTOMER_RESERVATION_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID),
...
(
  ...
  CONSTRAINT FK_CANCELED_CUSTOMER_RESERVATION_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO
...
(
  ...
  CONSTRAINT FK_MODIFIED_CUSTOMER_RESREVATION_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO

CREATE TABLE CUSTOMER_RESERVATION_LOG
(
	CUSTOMER_RESERVATION_LOG_ID INT NOT NULL IDENTITY(1,1),
	CUSTOMER_RESERVATION_ID int not null,
	RECORD_LOG_TYPE_ID SMALLINT NOT NULL,
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL,
	CONSTRAINT PK_CUSTOMER_RESERVATION_LOG PRIMARY KEY (CUSTOMER_RESERVATION_LOG_ID),
	CONSTRAINT FK_CUSTOMER_RESERVATION_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO

CREATE TABLE CUSTOMER_RESERVATION_DETAIL_LOG
(
	CUSTOMER_RESERVATION_DETAIL_LOG_ID INT NOT NULL IDENTITY(1,1),
	CUSTOMER_RESERVATION_DETAIL_ID INT NOT NULL,
	RECORD_LOG_TYPE_ID SMALLINT NOT NULL,
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL,
	CONSTRAINT PK_CUSTOMER_RESERVATION_DETAIL_LOG PRIMARY KEY (CUSTOMER_RESERVATION_DETAIL_LOG_ID),
	CONSTRAINT FK_CUSTOMER_RESERVATION_DETAIL_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO
...
(
	...
	ASPNETUSER_RECIPIENT_ID NVARCHAR(450) NOT NULL, 
	CREATION_DATE DATETIME DEFAULT GETDATE() NOT NULL,
	...
	CONSTRAINT FK_CUSTOMER_ORDER_IN_PROCESS_ASPNETUSER FOREIGN KEY (ASPNETUSER_RECIPIENT_ID) REFERENCES ASPNETUSERS (ID)	
)
GO
...
CREATE TABLE CANCELED_ORDER_IN_PROCESS
(
  CUSTOMER_ORDER_IN_PROCESS_ID int NOT NULL,
  CANCELLATION_REASON_ID SMALLINT NOT NULL,
  ASPNETUSER_ID NVARCHAR(450) NOT NULL,
  ...
  CONSTRAINT FK_CANCELED_CUSTOMER_ORDER_IN_PROCESS_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO

CREATE TABLE MODIFIED_ORDER_IN_PROCESS
(
  ...
  CONSTRAINT FK_MODIFIED_CUSTOMER_ORDER_IN_PROCESS_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO

CREATE TABLE CUSTOMER_ORDER_IN_PROCESS_LOG
(
	CUSTOMER_ORDER_IN_PROCESS_LOG_ID INT NOT NULL IDENTITY(1,1),
	CUSTOMER_ORDER_IN_PROCESS_ID int not null,
	RECORD_LOG_TYPE_ID SMALLINT NOT NULL,
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL,
	CONSTRAINT PK_CUSTOMER_ORDER_IN_PROCESS_LOG PRIMARY KEY (CUSTOMER_ORDER_IN_PROCESS_LOG_ID),
	CONSTRAINT FK_CUSTOMER_ORDER_IN_PROCESS_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO

CREATE TABLE CUSTOMER_ORDER_IN_PROCESS_DETAIL_LOG
(
	CUSTOMER_ORDER_IN_PROCESS_DETAIL_LOG_ID INT NOT NULL IDENTITY(1,1),
	CUSTOMER_ORDER_IN_PROCESS_DETAIL_ID INT NOT NULL,
	RECORD_LOG_TYPE_ID SMALLINT NOT NULL,
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL,
	CONSTRAINT PK_CUSTOMER_ORDER_IN_PROCESS_DETAIL_LOG PRIMARY KEY (CUSTOMER_ORDER_IN_PROCESS_DETAIL_LOG_ID),
	CONSTRAINT FK_CUSTOMER_ORDER_IN_PROCESS_DETAIL_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO
...
(
	...
	CONSTRAINT FK_CUSTOMER_ORDER_SHIPMENT_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO
...
(
	...
	CONSTRAINT FK_CUSTMER_ORDER_SHIPMENT_DETAIL_WAREHOUSES FOREIGN KEY (WAREHOUSE_ID) REFERENCES WAREHOUSES (WAREHOUSE_ID),
...
(
  ...
  CONSTRAINT FK_CANCELED_CUSTOMER_ORDER_SHIPMENT_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO
...
(
  ...
  CONSTRAINT FK_MODIFIED_CUSTOMER_ORDER_SHIPMENT_ASPNETUSER FOREIGN KEY (ASPNETUSER_ID) REFERENCES ASPNETUSERS (ID)
)
GO

CREATE TABLE CUSTOMER_ORDER_SHIPMENT_LOG
(
	CUSTOMER_ORDER_SHIPMENT_LOG_ID INT NOT NULL IDENTITY(1,1),
	CUSTOMER_ORDER_SHIPMENT_ID int not null,
	RECORD_LOG_TYPE_ID SMALLINT NOT NULL,
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL,
	CONSTRAINT PK_CUSTOMER_ORDER_SHIPMENT_LOG PRIMARY KEY (CUSTOMER_ORDER_SHIPMENT_LOG_ID),
	CONSTRAINT FK_CUSTOMER_ORDER_SHIPMENT_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO

CREATE TABLE CUSTOMER_ORDER_SHIPMENT_DETAIL_LOG
(
	CUSTOMER_ORDER_SHIPMENT_DETAIL_LOG_ID INT NOT NULL IDENTITY(1,1),
	CUSTOMER_ORDER_SHIPMENT_DETAIL_ID INT NOT NULL,
	RECORD_LOG_TYPE_ID SMALLINT NOT NULL,
	LOG_DATE DATETIME DEFAULT GETDATE() NOT NULL, 	
	DATA_STRING XML NOT NULL,
	CONSTRAINT PK_CUSTOMER_ORDER_SHIPMENT_DETAIL_LOG PRIMARY KEY (CUSTOMER_ORDER_SHIPMENT_DETAIL_LOG_ID),
	CONSTRAINT FK_CUSTOMER_ORDER_SHIPMENT_DETAIL_LOG_RECORD_LOG_TYPE FOREIGN KEY (RECORD_LOG_TYPE_ID) REFERENCES RECORD_LOG_TYPES (RECORD_LOG_TYPE_ID)
)
GO

/* creacion de triggers */

/* Triggers para ITEM_LOG */
CREATE TRIGGER TR_CREATE_LOG_ITEM
ON ITEMS 
FOR INSERT
AS
BEGIN
	DECLARE @RECORD_LOG_TYPE_ID SMALLINT, @XMLResultOUT XML, @ITEM_ID INT, @REC_NO INT = 1, @TOTAL_REC INT
	
	/*	Verifica si hay cambios para continuar con la ejecucion del trigger */
	IF NOT EXISTS(SELECT 1 FROM inserted)
		RETURN;
	
	SELECT @RECORD_LOG_TYPE_ID = RECORD_LOG_TYPE_ID 
	  FROM RECORD_LOG_TYPES 
	 WHERE UPPER(RECORD_LOG_TYPE_NAME) = 'CREATE'
										
	DECLARE @TABLE TABLE (REC_NO INT NOT NULL IDENTITY(1,1), ITEM_ID INT NOT NULL)

	INSERT INTO @TABLE (ITEM_ID) 
	     SELECT ITEM_ID 
		   FROM inserted

	SELECT @TOTAL_REC = MAX(REC_NO) 
	  FROM @TABLE
	...
	BEGIN
		...
		/* Se obtiene el registro creado */
		SELECT @XMLResultOUT = (SELECT * FROM inserted WHERE ITEM_ID = @ITEM_ID FOR XML PATH('ITEMS'), ELEMENTS, TYPE)
		
		INSERT INTO ITEM_LOG (ITEM_ID, RECORD_LOG_TYPE_ID, LOG_DATE, DATA_STRING) 
			 VALUES (@ITEM_ID, @RECORD_LOG_TYPE_ID, GETDATE(), @XMLResultOUT)
...
CREATE TRIGGER TR_MODIFY_LOG_ITEM
ON ITEMS 
FOR UPDATE
AS
BEGIN
	...
	SELECT @RECORD_LOG_TYPE_ID = RECORD_LOG_TYPE_ID 
	  FROM RECORD_LOG_TYPES 
	 WHERE UPPER(RECORD_LOG_TYPE_NAME) = 'MODIFY'
	...
	INSERT INTO @TABLE (ITEM_ID) 
	     SELECT d.ITEM_ID 
		  ...
		  WHERE D.CIF_COST <> I.CIF_COST
		     OR D.CIF_MEASURE_UNIT_ID <> I.CIF_MEASURE_UNIT_ID
			 OR D.CURRENCY_ID <> I.CURRENCY_ID
			 OR D.FOB_COST <> I.FOB_COST
			 OR D.FOB_MEASURE_UNIT_ID <> i.FOB_MEASURE_UNIT_ID
			 OR D.INTERNAL_REFERENCE <> I.INTERNAL_REFERENCE
			 OR D.IS_ACTIVE <> I.IS_ACTIVE
			 OR D.IS_CATALOG_VISIBLE <> I.IS_CATALOG_VISIBLE
			 OR D.IS_DOMESTIC_PRODUCT <> I.IS_DOMESTIC_PRODUCT
			 OR D.IS_EXTERNAL_INVENTORY <> I.IS_EXTERNAL_INVENTORY
			 OR D.ITEM_NAME <> I.ITEM_NAME
			 OR D.NOTES <> I.NOTES
			 OR D.PROVIDER_ITEM_NAME <> I.PROVIDER_ITEM_NAME
			 OR D.PROVIDER_REFERENCE <> I.PROVIDER_REFERENCE
			 OR D.VOLUME <> I.VOLUME
			 OR D.WEIGHT <> I.WEIGHT
	...
	BEGIN
		...
		/* Se obtiene el registro creado */
		SELECT @XMLResultOUT = (SELECT * FROM deleted WHERE ITEM_ID = @ITEM_ID FOR XML PATH('ITEMS'), ELEMENTS, TYPE)
...
CREATE TRIGGER TR_DELETE_LOG_ITEM
ON ITEMS 
FOR DELETE
AS
BEGIN
	...
	SELECT @RECORD_LOG_TYPE_ID = RECORD_LOG_TYPE_ID 
	  FROM RECORD_LOG_TYPES 
	 WHERE UPPER(RECORD_LOG_TYPE_NAME) = 'DELETE'
...
CREATE TRIGGER TR_CREATE_LOG_ITEM_REFERENCE
ON ITEM_REFERENCES 
FOR INSERT
AS
BEGIN
	DECLARE @RECORD_LOG_TYPE_ID SMALLINT, @XMLResultOUT XML, @REFERENCE_ID INT, @REC_NO INT = 1, @TOTAL_REC INT
	...
	DECLARE @TABLE TABLE (REC_NO INT NOT NULL IDENTITY(1,1), REFERENCE_ID INT NOT NULL)

	INSERT INTO @TABLE (REFERENCE_ID) 
	     SELECT REFERENCE_ID 
		   FROM inserted
	...
	BEGIN
		...
		/* Se obtiene el registro creado */
		SELECT @XMLResultOUT = (SELECT * FROM inserted WHERE REFERENCE_ID = @REFERENCE_ID FOR XML PATH('ITEMS'), ELEMENTS, TYPE)
		
		INSERT INTO ITEM_REFERENCE_LOG (REFERENCE_ID, RECORD_LOG_TYPE_ID, LOG_DATE, DATA_STRING) 
			 VALUES (@REFERENCE_ID, @RECORD_LOG_TYPE_ID, GETDATE(), @XMLResultOUT)
...
CREATE TRIGGER TR_MODIFY_LOG_ITEM_REFERENCE
ON ITEM_REFERENCES 
FOR UPDATE
AS
BEGIN
	...
	INSERT INTO @TABLE (REFERENCE_ID) 
	     SELECT d.REFERENCE_ID
		   FROM inserted I
		   JOIN deleted D ON D.REFERENCE_ID = i.REFERENCE_ID
		  WHERE D.ALARM_MINIMUM_QUANTITY <> I.ALARM_MINIMUM_QUANTITY
		     OR D.IS_ACTIVE <> I.IS_ACTIVE
			 OR D.IS_SOLD_OUT <> I.IS_SOLD_OUT
			 OR D.NOTES <> I.NOTES
			 OR D.PROVIDER_REFERENCE_CODE <> i.PROVIDER_REFERENCE_CODE
			 OR D.PROVIDER_REFERENCE_NAME <> I.PROVIDER_REFERENCE_NAME
			 OR D.REFERENCE_CODE <> I.REFERENCE_CODE
			 OR D.REFERENCE_NAME <> I.REFERENCE_NAME
	...
	BEGIN
		...
		/* Se obtiene el registro creado */
		SELECT @XMLResultOUT = (SELECT * FROM deleted WHERE REFERENCE_ID = @REFERENCE_ID FOR XML PATH('ITEM_REFERENCES'), ELEMENTS, TYPE)
...
CREATE TRIGGER TR_DELETE_LOG_ITEM_REFERENCE
ON ITEM_REFERENCES 
FOR DELETE
AS
BEGIN
	...
	BEGIN
		...
		/* Se obtiene el registro creado */
		SELECT @XMLResultOUT = (SELECT * FROM deleted WHERE ITEM_ID = @REFERENCE_ID FOR XML PATH('ITEMS'), ELEMENTS, TYPE)
...
CREATE INDEX IND_CUSTOMER_ORDER_LOG ON CUSTOMER_ORDER_LOG (CUSTOMER_ORDER_ID, LOG_DATE)
CREATE INDEX IND_CUSTOMER_ORDER_DETAIL_LOG ON CUSTOMER_ORDER_DETAIL_LOG (CUSTOMER_ORDER_DETAIL_ID, LOG_DATE)
CREATE INDEX IND_PURCHASE_ORDER_LOG ON PURCHASE_ORDER_LOG (PURCHASE_ORDER_ID, LOG_DATE)
CREATE INDEX IND_PURCHASE_ORDER_DETAIL_LOG ON PURCHASE_ORDER_DETAIL_LOG (PURCHASE_ORDER_DETAIL_ID, LOG_DATE)
CREATE INDEX IND_CUSTOMER_RESERVATION_LOG ON CUSTOMER_RESERVATION_LOG (CUSTOMER_RESERVATION_ID, LOG_DATE)
CREATE INDEX IND_CUSTOMER_RESERVATION_DETAIL_LOG ON CUSTOMER_RESERVATION_DETAIL_LOG (CUSTOMER_RESERVATION_DETAIL_ID, LOG_DATE)

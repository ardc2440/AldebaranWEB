...
(
  ...
  EMPLOYEE_ID INT NOT NULL,
  ORIGEN_WAREHOUSE_ID SMALLINT NOT NULL,
  DESTINATION_WAREHOUSE_ID SMALLINT NOT NULL,
  NOTES VARCHAR(250),
  CREATION_DATE DATETIME DEFAULT GETDATE()  NOT NULL,
  NATIONALIZATION VARCHAR(30),
  STATUS_DOCUMENT_TYPE_ID SMALLINT NOT NULL
  CONSTRAINT PK_WARHOUSE_TRANSFER PRIMARY KEY (WAREHOUSE_TRANSFER_ID),
  CONSTRAINT FK_WARHOUSE_TRANSFER_ORIGEN_WAREHOUSE FOREIGN KEY (ORIGEN_WAREHOUSE_ID) REFERENCES WAREHOUSES(WAREHOUSE_ID), 
  CONSTRAINT FK_WARHOUSE_TRANSFER_DESTINATION_WAREHOUSE FOREIGN KEY (DESTINATION_WAREHOUSE_ID) REFERENCES WAREHOUSES(WAREHOUSE_ID), 
  CONSTRAINT FK_WARHOUSE_TRANSFER_EMPLOYEE FOREIGN KEY (EMPLOYEE_ID) REFERENCES EMPLOYEES (EMPLOYEE_ID), 
  CONSTRAINT FK_WARHOUSE_TRANSFER_STATUS_DOCUMENT_TYPE FOREIGN KEY (STATUS_DOCUMENT_TYPE_ID) REFERENCES STATUS_DOCUMENT_TYPES (STATUS_DOCUMENT_TYPE_ID) 
)
GO
...
(
  ...
  CONSTRAINT FK_WAREHOUSE_TRANSFER_DETAIL_WAREHOUSE_TRANSFER FOREIGN KEY (WAREHOUSE_TRANSFER_ID) REFERENCES ITEM_REFERENCES (REFERENCE_ID),
  CONSTRAINT FK_WAREHOUSE_TRANSFER_DETAIL_ITEM_REFERENCE FOREIGN KEY (REFERENCE_ID) REFERENCES WAREHOUSE_TRANSFERS (WAREHOUSE_TRANSFER_ID)
)
GO

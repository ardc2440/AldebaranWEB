...
namespace Aldebaran.DataAccess.Infraestructure.Repository
{
    public interface IPurchaseOrderRepository
    {
        ...
        Task ConfirmAsync(int purchaseOrderId, PurchaseOrder purchaseOrder, int? approvalEmployeeId, string? approvalReason, CancellationToken ct = default);
        ...
        Task<int> DenyAdjustmentApproval(PurchaseOrderAdjustmentLog denyAdjustmentApproval, CancellationToken ct = default);

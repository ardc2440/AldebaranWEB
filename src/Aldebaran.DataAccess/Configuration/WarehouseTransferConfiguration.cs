...
namespace Aldebaran.DataAccess.Entities
{
    public class WarehouseTransferConfiguration : IEntityTypeConfiguration<WarehouseTransfer>
    {
        public void Configure(EntityTypeBuilder<WarehouseTransfer> builder)
        {
            ...
            // Foreign keys
            builder.HasOne(a => a.OriginWarehouse).WithMany(b => b.OriginWarehouseTransfers).HasForeignKey(c => c.OriginWarehouseId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_WARHOUSE_TRANSFER_ORIGIN_WAREHOUSE");

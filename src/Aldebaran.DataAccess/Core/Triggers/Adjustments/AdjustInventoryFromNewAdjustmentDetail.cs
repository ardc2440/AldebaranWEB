    ...
    public class AdjustInventoryFromNewAdjustmentDetail : InventoryManagementBase, IBeforeSaveTrigger<AdjustmentDetail>
    {
        ...
        public async Task BeforeSave(ITriggerContext<AdjustmentDetail> context, CancellationToken cancellationToken)
        {
            if (context.ChangeType == ChangeType.Added)
            {
                ...
                await UpdateInventoryQuantityAsync(context.Entity.ReferenceId, context.Entity.Quantity, adjustmentType.Operator, cancellationToken);
                await UpdateWarehouseReferenceQuantityAsync(context.Entity.WarehouseId, context.Entity.ReferenceId, context.Entity.Quantity, adjustmentType.Operator, cancellationToken);
            }
        }
    }
}

...
{
    public class AdjustInventoryFromNewOrderShipmentDetail : InventoryManagementBase, IBeforeSaveTrigger<CustomerOrderShipmentDetail>
    {
        private readonly AldebaranDbContext _context;

        public AdjustInventoryFromNewOrderShipmentDetail(AldebaranDbContext context) : base(context)
        {

...
{
    public class AldebaranDashBoardDbContext : DbContext
    {
        public Dictionary<string, bool> Events = new();

        public AldebaranDashBoardDbContext()
        {

        }
        public AldebaranDashBoardDbContext(DbContextOptions<AldebaranDashBoardDbContext> options)
            : base(options)
        {

using Aldebaran.Services.Notificator.Notify;
using Aldebaran.Services.Notificator.Notify.EmailProvider.Services;
using Aldebaran.Services.Notificator.Notify.Model;

namespace Aldebaran.Services.Notificator.Notify.EmailProvider
{

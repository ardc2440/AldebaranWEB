using Aldebaran.Services.Notificator.Notify.EmailProvider.Models;

namespace Aldebaran.Services.Notificator.Notify.EmailProvider.Services
{
    /// <summary>
    ...
    public interface IEmailService
    {
        ...
        /// <returns></returns>
        Task SendAsync(string subject, string body, string[] to, string[] cc, string[] bcc, Attachment[]? attachments, CancellationToken ct = default);
    }
}

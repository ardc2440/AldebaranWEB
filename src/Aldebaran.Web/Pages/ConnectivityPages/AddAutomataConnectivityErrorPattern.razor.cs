...
{
    public partial class AddAutomataConnectivityErrorPattern
    {
        [Inject]
        ...
        [Inject]
        protected ILogger<AddAutomataConnectivityErrorPattern> Logger { get; set; }

        protected AutomataConnectivityErrorPattern Pattern = new() { IsActive = true, Target = "D" };
        ...
        protected async Task FormSubmit()
        {
            ...
            try
            {
                ...
                await AutomataConnectivityErrorPatternService.CreateAsync(Pattern);

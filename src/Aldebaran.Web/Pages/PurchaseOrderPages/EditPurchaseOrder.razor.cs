...
namespace Aldebaran.Web.Pages.PurchaseOrderPages
{
    public partial class EditPurchaseOrder
    {
        ...
        {
            purchaseOrder = await AldebaranDbService.GetPurchaseOrderByPurchaseOrderId(PURCHASE_ORDER_ID);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await AldebaranDbService.UpdatePurchaseOrder(PURCHASE_ORDER_ID, purchaseOrder);

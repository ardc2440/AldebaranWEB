...
{
    public partial class BackOrderReportFilter
    {
        #region Injections
        [Inject]
        ...
        #region Parameters
        [Parameter]
        public BackOrderFilter Filter { get; set; } = new();
        #endregion
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            StatusDocumentTypes = StatusDocumentTypes.Where(s => s.StatusOrder >= 1 && s.StatusOrder <= 3).ToList();

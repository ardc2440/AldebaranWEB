...
namespace Aldebaran.Web.Pages.ReportPages.Customer_Order_Activities
{
    public partial class CustomerOrderActivityReport
    {
                            ...
                            new CustomerOrderActivityViewModel.Order
                            {
                                ...
                                References = new List<CustomerOrderActivityViewModel.Reference>
                                {
                                    new CustomerOrderActivityViewModel.Reference
                                    {
                                        ...
                                        Shipments = new List<CustomerOrderActivityViewModel.Shipment>
                                        {
                                            new CustomerOrderActivityViewModel.Shipment
                                            {
                                                CreationDate= DateTime.Now,
                                                ...
                                                References = new List<CustomerOrderActivityViewModel.ShipmentReference>
                                                {
                                                    new CustomerOrderActivityViewModel.ShipmentReference
                                                    {
                                                        ItemReference="5000SM",
                                                        ItemName="GILDAN CAMISETA T-SHIRT",
                                                        ReferenceCode="032",
        ...
        {
            var result = await DialogService.OpenAsync<CustomerOrderReportFilter>("Filtrar reporte de ordenes por cliente", parameters: new Dictionary<string, object> { { "Filter", (CustomerOrderActivityFilter)Filter?.Clone() } }, options: new DialogOptions { Width = "800px" });
            if (result == null)
                return;

...
{
    public partial class EditItemsArea
    {
        [Inject]
        ...
        {
            itemsArea = await AldebaranDbService.GetItemsAreaByItemIdAndAreaId(ITEM_ID, AREA_ID);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await AldebaranDbService.UpdateItemsArea(ITEM_ID, AREA_ID, itemsArea);

    ...
    public partial class EditCustomerOrderInProcess
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            try
            {
                ...
                var customerOrders = await AldebaranDbService.GetCustomerOrders(new Query { Filter = $@"i => i.CUSTOMER_ORDER_ID.Equals(@0)", FilterParameters = new object[] { customerOrderInProcessId }, Expand = "Customer.City.Department.Country" });
